...
# Global variables
page_cnt = 3000 # upper bound of classes
sem = sys.argv[1] # specify which semester to scrap
url = "http://nol.ntu.edu.tw/nol/coursesearch/search_result.php" # class searching page
file_name = sys.argv[2] # output excel form
